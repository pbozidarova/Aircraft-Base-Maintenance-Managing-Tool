...
import EditUserComponent from '../func/UserEditComponent'
...
class UsersComponent extends Component {
    ...
    render(){
        ...
        const emptyRows = this.state.rowsPerPage - Math.min(this.state.rowsPerPage, this.state.users.length - this.state.page * this.state.rowsPerPage);
        return(
